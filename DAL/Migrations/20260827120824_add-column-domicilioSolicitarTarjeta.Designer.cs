...
namespace DAL.Migrations
{
    ...
    [Migration("20260827120824_add-column-domicilioSolicitarTarjeta")]
    partial class addcolumndomicilioSolicitarTarjeta
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Core.Notificaciones", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("TipoNotificacionesProcedimientosId");

                    b.Property<int>("Variable1");

                    b.Property<int>("Variable2");

                    b.Property<int>("Variable3");
                    ...
                    b.HasIndex("TipoNotificacionesProcedimientosId");

                    b.ToTable("Notificaciones");
                });

            modelBuilder.Entity("DAL.Models.Core.NotificacionesPlantillas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("NotificacionesPlantillas");
                });
            ...
            modelBuilder.Entity("DAL.Models.Core.Procedimientos", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaUltimaEjecucionExitosa");
            ...
            modelBuilder.Entity("DAL.Models.Core.TipoNotificacionesProcedimientos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("TipoNotificacionesProcedimientos");
                });
            ...
            modelBuilder.Entity("DAL.Models.EstadoSolicitudDeTarjeta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("EstadoSolicitudDeTarjeta");
                });
            ...
            modelBuilder.Entity("DAL.Models.HistorialCanje", b =>
                {
                    ...
                    b.Property<DateTime>("FechaVencimientoCupon");

                    b.Property<string>("NroTarjeta");

                    b.Property<int?>("PremioId");

                    b.Property<long>("PuntosConsumidos");

                    b.Property<long>("PuntosRestantes");
            ...
            modelBuilder.Entity("DAL.Models.Marcas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.MenuMobile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("MenuMobile");
                });

            modelBuilder.Entity("DAL.Models.MenuMobileUsuariosHabilitados", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("MenuMobileId");

                    b.Property<string>("UsuarioId");

                    b.HasKey("Id");

                    b.HasIndex("MenuMobileId");

                    b.HasIndex("UsuarioId");

                    b.ToTable("MenuMobileUsuariosHabilitados");
                });
            ...
            modelBuilder.Entity("DAL.Models.Morosos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.Persona", b =>
                {
                    ...
                    b.Property<int?>("PersonaIdCpeCreditos");
            ...
            modelBuilder.Entity("DAL.Models.PreRegistroCategorias", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("PreRegistroCategorias");
                });
            ...
            modelBuilder.Entity("DAL.Models.SolicitudDeTarjeta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<byte[]>("DorsoDNI");

                    b.Property<string>("Email");

                    b.Property<int?>("EstadoId");

                    b.Property<DateTime>("FechaDeRechazoAprobacion");

                    b.Property<DateTime>("FechaNacimiento");

                    b.Property<DateTime>("FechaSolicitud");

                    b.Property<byte[]>("FrenteDNI");
            ...
            modelBuilder.Entity("DAL.Models.SucursalesMarcas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.Usuario", b =>
                {
                    ...
                    b.Property<bool>("RecibirResumen");
                    ...
                    b.Property<bool>("UsuarioSucursal");

                    b.Property<int?>("UsuariosCategoriasId");
                    ...
                    b.HasIndex("UsuariosCategoriasId");
            ...
            modelBuilder.Entity("DAL.Models.UsuariosCategorias", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.Banners", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Marcas", "Marcas")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Models.Catalogo", b =>
                {
                    b.HasOne("DAL.Models.Marcas", "Marca")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Models.Core.Notificaciones", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Core.TipoNotificacionesProcedimientos", "TipoNotificacionesProcedimientos")
                        .WithMany()
                        .HasForeignKey("TipoNotificacionesProcedimientosId");
                });
            ...
            modelBuilder.Entity("DAL.Models.MenuMobileUsuariosHabilitados", b =>
                {
                    b.HasOne("DAL.Models.MenuMobile", "MenuMobile")
                        .WithMany()
                        .HasForeignKey("MenuMobileId");
            ...
            modelBuilder.Entity("DAL.Models.SolicitudDeTarjeta", b =>
                {
                    b.HasOne("DAL.Models.EstadoSolicitudDeTarjeta", "Estado")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Models.SucursalesMarcas", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Sucursales", "Sucursales")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Models.Usuario", b =>
                {
                    ...
                    b.HasOne("DAL.Models.UsuariosCategorias", "UsuariosCategorias")
                        .WithMany()
                        .HasForeignKey("UsuariosCategoriasId");
